...
SET(MKL_THREAD_VARIANTS SEQUENTIAL GNUTHREAD INTELTHREAD TBBTHREAD)
...
ELSEIF(MKL_ROOT_DIR) # UNIX and macOS
        ...
        # Lapack
        IF("${MKL_ARCH_DIR}" STREQUAL "32")
                FIND_LIBRARY(MKL_LP_LAPACK_LIBRARY
                  mkl_lapack
                  PATHS
                        ${MKL_ROOT_DIR}/lib/${MKL_ARCH_DIR}
                        ${MKL_ROOT_DIR}/lib/
                ...
                FIND_LIBRARY(MKL_ILP_LAPACK_LIBRARY
                  mkl_lapack
                  PATHS
                        ${MKL_ROOT_DIR}/lib/${MKL_ARCH_DIR}
                        ${MKL_ROOT_DIR}/lib/
                ...
                foreach (THREADVAR ${MKL_THREAD_VARIANTS})
                        if (MKL_CORE_LIBRARY AND MKL_${MODEVAR}_LIBRARY AND MKL_${THREADVAR}_LIBRARY)
                                set(MKL_${MODEVAR}_${THREADVAR}_LIBRARIES
                                        ...
                                        ${MKL_${MODEVAR}_LAPACK_LIBRARY} ${MKL_IOMP5_LIBRARY})
        ...
        IF(APPLE)
            SET(MKL_LIBRARIES ${MKL_ILP_INTELTHREAD_LIBRARIES})
        ELSE()
                IF(TBB_FOUND)
                    SET(MKL_LIBRARIES ${MKL_ILP_TBBTHREAD_LIBRARIES})
                ELSE()
                    SET(MKL_LIBRARIES ${MKL_ILP_GNUTHREAD_LIBRARIES})
                ENDIF()
        ENDIF()
        
        MARK_AS_ADVANCED(MKL_CORE_LIBRARY MKL_LP_LIBRARY MKL_ILP_LIBRARY
                MKL_SEQUENTIAL_LIBRARY MKL_INTELTHREAD_LIBRARY MKL_GNUTHREAD_LIBRARY MKL_TBBTHREAD_LIBRARY)
ENDIF()
